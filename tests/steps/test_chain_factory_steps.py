...
@scenario(
    "../features/chain_factory.feature",
    "Provide a LLM chain by valid chain type and message parameter",
)
...
def get_prompt_template():
    patcher = patch.object(
        PromptFactory, "get_prompt", return_value=Mock(spec=ChatPromptTemplate)
    )
    patcher.start()
    yield
    patcher.stop()
